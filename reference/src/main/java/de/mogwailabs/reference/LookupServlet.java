package de.mogwailabs.reference;
import java.io.File;
...
public class LookupServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            // This only works because we specified
            // ENV CATALINA_OPTS="-Dcom.sun.jndi.ldap.object.trustURLCodebase=true
            // in the Dockerfile.
            Object resource = new javax.naming.InitialContext().lookup(resourceName);
